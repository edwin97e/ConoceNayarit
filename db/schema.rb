...
ActiveRecord::Schema.define(version: 2019_07_04_204823) do
  ...
  create_table "sitecategories", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "sites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "sitecategory_id"
    t.string "img_file_name"
    t.string "img_content_type"
    t.bigint "img_file_size"
    t.datetime "img_updated_at"
    t.index ["sitecategory_id"], name: "index_sites_on_sitecategory_id"
  end

  add_foreign_key "events", "eventcategories"
  add_foreign_key "sites", "sitecategories"
end
